...
const technologyLogos: Technology[] = [
  { name: "PHP", logo: "/logos/php.svg", href: "https://www.php.net/" },
  ...
  { name: "Next.js", logo: "/logos/nextdotjs.svg", href: "https://nextjs.org/", darkModeLight: true },
  { name: "TYPO3", logo: "/logos/typo3.svg", href: "https://typo3.org/" },
  { name: "Angular", logo: "/logos/angular.svg", href: "https://angular.dev/" },
  { name: "Vue", logo: "/logos/vuedotjs.svg", href: "https://vuejs.org/" },
  { name: "GitHub", logo: "/logos/github.svg", href: "https://github.com/", darkModeLight: true },
  { name: "GitLab", logo: "/logos/gitlab.svg", href: "https://gitlab.com/" },
  { name: "Gitea", logo: "/logos/gitea.svg", href: "https://about.gitea.com/" },
  { name: "Docker", logo: "/logos/docker.svg", href: "https://www.docker.com/" },
  { name: "Proxmox", logo: "/logos/proxmox.svg", href: "https://www.proxmox.com/" },
  { name: "Linux", logo: "/logos/linux.svg", href: "https://www.linux.org/" },
  { name: "macOS", logo: "/logos/apple.svg", href: "https://www.apple.com/macos/", darkModeLight: true },
  { name: "Astro", logo: "/logos/astro.svg", href: "https://astro.build/" },
  { name: "Cloudflare", logo: "/logos/cloudflare.svg", href: "https://www.cloudflare.com/" },
  { name: "Bun", logo: "/logos/bun.svg", href: "https://bun.sh/", darkModeLight: true },
  { name: "Claude", logo: "/logos/claude.svg", href: "https://claude.ai/" },
  { name: "Codex", logo: "/logos/openai.svg", href: "https://openai.com/codex", darkModeLight: true },
  { name: "Cursor", logo: "/logos/cursor.svg", href: "https://cursor.com/", darkModeLight: true },
  { name: "Gemini", logo: "/logos/googlegemini.svg", href: "https://gemini.google.com/" },
  { name: "Perplexity", logo: "/logos/perplexity.svg", href: "https://www.perplexity.ai/" },
  { name: "VS Code", logo: "/logos/vscode.svg", href: "https://code.visualstudio.com/" },
  { name: "PhpStorm", logo: "/logos/phpstorm.svg", href: "https://www.jetbrains.com/phpstorm/", darkModeLight: true },
  { name: "Windows", logo: "/logos/windows11.svg", href: "https://www.microsoft.com/windows" },
  { name: "Tailwind CSS", logo: "/logos/tailwindcss.svg", href: "https://tailwindcss.com/" },
];
